...
/** @type {string} */
const CACHE_VERSION = '1747649130|17540382096';
/** @type {string} */
const CACHE_PREFIX = 'BubbleFall-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'BubbleFall.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["BubbleFall.html","BubbleFall.js","BubbleFall.offline.html","BubbleFall.icon.png","BubbleFall.apple-touch-icon.png","BubbleFall.worker.js","BubbleFall.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["BubbleFall.wasm","BubbleFall.pck"];
